...
# Deploy the CloudFormation stack with the simplified template
echo "Deploying ADOT Collector with simplified configuration..."
aws cloudformation deploy \
  --template-file adot-collector-simplified.yaml \
