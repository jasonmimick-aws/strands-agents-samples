...
- `adot-collector-deployment.yaml`: CloudFormation template for deploying ADOT
- `otel-collector-config.yaml`: Configuration for ADOT Collector with Datadog exporter
- `deploy-adot.sh`: Deployment script
